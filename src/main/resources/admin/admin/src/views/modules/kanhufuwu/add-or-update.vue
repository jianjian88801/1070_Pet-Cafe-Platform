<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宠物类型" prop="chongwuleixing">
          <el-input v-model="ruleForm.chongwuleixing" 
              placeholder="宠物类型" clearable  :readonly="ro.chongwuleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宠物类型" prop="chongwuleixing">
              <el-input v-model="ruleForm.chongwuleixing" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="性情" prop="xingqing">
          <el-input v-model="ruleForm.xingqing" 
              placeholder="性情" clearable  :readonly="ro.xingqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="性情" prop="xingqing">
              <el-input v-model="ruleForm.xingqing" 
                placeholder="性情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="寄养时间" prop="jiyangshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jiyangshijian" 
                type="date"
                placeholder="寄养时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiyangshijian" label="寄养时间" prop="jiyangshijian">
              <el-input v-model="ruleForm.jiyangshijian" 
                placeholder="寄养时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="喂食" prop="weishi">
          <el-input v-model="ruleForm.weishi" 
              placeholder="喂食" clearable  :readonly="ro.weishi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="喂食" prop="weishi">
              <el-input v-model="ruleForm.weishi" 
                placeholder="喂食" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="剪毛" prop="jianmao">
          <el-input v-model="ruleForm.jianmao" 
              placeholder="剪毛" clearable  :readonly="ro.jianmao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="剪毛" prop="jianmao">
              <el-input v-model="ruleForm.jianmao" 
                placeholder="剪毛" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="领回时间" prop="linghuishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.linghuishijian" 
                type="date"
                placeholder="领回时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.linghuishijian" label="领回时间" prop="linghuishijian">
              <el-input v-model="ruleForm.linghuishijian" 
                placeholder="领回时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="看护姓名" prop="kanhuxingming">
          <el-input v-model="ruleForm.kanhuxingming" 
              placeholder="看护姓名" clearable  :readonly="ro.kanhuxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="看护姓名" prop="kanhuxingming">
              <el-input v-model="ruleForm.kanhuxingming" 
                placeholder="看护姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingqing = true;
          ...
          if(o=='jiyangshijian'){
            this.ruleForm.jiyangshijian = obj[o];
	    this.ro.jiyangshijian = true;
            continue;
          }
          if(o=='weishi'){
            this.ruleForm.weishi = obj[o];
	    this.ro.weishi = true;
            continue;
          }
          if(o=='jianmao'){
            this.ruleForm.jianmao = obj[o];
	    this.ro.jianmao = true;
            continue;
          }
          if(o=='shipin'){
	    ...
	    this.ro.shipin = true;
          ...
          if(o=='linghuishijian'){
            this.ruleForm.linghuishijian = obj[o];
	    this.ro.linghuishijian = true;
            continue;
          }
          if(o=='gonghao'){
	    ...
	    this.ro.gonghao = true;
          ...
          if(o=='kanhuxingming'){
            this.ruleForm.kanhuxingming = obj[o];
	    this.ro.kanhuxingming = true;
            continue;
          }
        }
      }
      ...
      this.$http({
		...
		if(json.kanhuxingming!=''&&json.kanhuxingming){
              		this.ruleForm.kanhuxingming = json.kanhuxingming
		}
        } else {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kanhufuwu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kanhufuwuCrossAddOrUpdateFlag = false;
                  this.parent.search();
