...
public class CaipinleixingController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,CaipinleixingEntity caipinleixing, HttpServletRequest request){
        EntityWrapper<CaipinleixingEntity> ew = new EntityWrapper<CaipinleixingEntity>();
		PageUtils page = caipinleixingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, caipinleixing), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<CaipinleixingEntity> wrapper = new EntityWrapper<CaipinleixingEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = caipinleixingService.selectCount(wrapper);
