...
public class ChongwutiyanController {
    ...
    public R save(@RequestBody ChongwutiyanEntity chongwutiyan, HttpServletRequest request){
    	...
    	//ValidatorUtils.validateEntity(chongwutiyan);
    ...
    public R update(@RequestBody ChongwutiyanEntity chongwutiyan, HttpServletRequest request){
        //ValidatorUtils.validateEntity(chongwutiyan);
        chongwutiyanService.updateById(chongwutiyan);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ChongwutiyanEntity> wrapper = new EntityWrapper<ChongwutiyanEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = chongwutiyanService.selectCount(wrapper);
