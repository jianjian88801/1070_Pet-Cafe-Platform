<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="注射疫苗次数" prop="zhusheyimiaocishu">
          <el-input v-model="ruleForm.zhusheyimiaocishu" 
              placeholder="注射疫苗次数" clearable  :readonly="ro.zhusheyimiaocishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="注射疫苗次数" prop="zhusheyimiaocishu">
              <el-input v-model="ruleForm.zhusheyimiaocishu" 
                placeholder="注射疫苗次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="毛发修剪" prop="maofaxiujian">
          <el-input v-model="ruleForm.maofaxiujian" 
              placeholder="毛发修剪" clearable  :readonly="ro.maofaxiujian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="毛发修剪" prop="maofaxiujian">
              <el-input v-model="ruleForm.maofaxiujian" 
                placeholder="毛发修剪" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="洗护时间" prop="xihushijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.xihushijian" 
                type="date"
                placeholder="洗护时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xihushijian" label="洗护时间" prop="xihushijian">
              <el-input v-model="ruleForm.xihushijian" 
                placeholder="洗护时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='zhusheyimiaocishu'){
            this.ruleForm.zhusheyimiaocishu = obj[o];
	    this.ro.zhusheyimiaocishu = true;
            continue;
          }
          if(o=='zhusheshijian'){
	    ...
	    this.ro.zhusheshijian = true;
          ...
          if(o=='maofaxiujian'){
            this.ruleForm.maofaxiujian = obj[o];
	    this.ro.maofaxiujian = true;
            continue;
          }
          if(o=='xihushijian'){
            this.ruleForm.xihushijian = obj[o];
	    this.ro.xihushijian = true;
            continue;
          }
          if(o=='xiangqing'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springbootx9rzc/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
