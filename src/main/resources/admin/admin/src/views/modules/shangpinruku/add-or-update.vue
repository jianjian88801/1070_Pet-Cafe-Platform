<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="详情" prop="xiangqing">
          <el-input v-model="ruleForm.xiangqing" 
              placeholder="详情" clearable  :readonly="ro.xiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="详情" prop="xiangqing">
              <el-input v-model="ruleForm.xiangqing" 
                placeholder="详情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
